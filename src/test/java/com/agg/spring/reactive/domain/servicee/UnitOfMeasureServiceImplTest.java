...
import com.agg.spring.reactive.service.UnitOfMeasureService;
import com.agg.spring.reactive.service.UnitOfMeasureServiceImpl;
...
public class UnitOfMeasureServiceImplTest {
    ...
    public void listAllUoms() throws Exception {
        ...
        //when
        List<UnitOfMeasureCommand> commands = service.listAllUOM().collectList().block();
